# Modified Version of DiscordGo with the websocket connection exposed

## Note from Noah
Whilst building a self bot project with this library I hit a roadblock where I was unable to manually send my own payloads to the DiscordAPI because the websocket connection is private in the library. <br>
So to avoid a massive anti pattern i decided forking it was the best solution
